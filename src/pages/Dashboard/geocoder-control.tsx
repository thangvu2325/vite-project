...
> & {
  ...
  onResults?: ((e: object) => void) | undefined; // Update type definition
...
export default function GeocoderControl(props: GeocoderControlProps) {
  const [marker, setMarker] = useState<JSX.Element | null>(null); // Ensure marker state can accept JSX elements
  ...
  const geocoder = useControl<MapboxGeocoder>(
    () => {
      ...
      ctrl.on("loading", props.onLoading || (() => {})); // Default to a no-op function if onLoading is undefined
